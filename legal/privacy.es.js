...
NO usamos el contenido de tus conversaciones para entrenar, ajustar ni mejorar ningún modelo de IA. NO vendemos, alquilamos ni compartimos el contenido de tus conversaciones con anunciantes ni intermediarios de datos.
...
7.3 Excepción para la protección de menores y la prevención del abuso: Si una cuenta es bloqueada (por ejemplo, porque pertenece a una persona menor de 18 años o por abuso), conservamos la versión criptográfica irreversible (hash) de la dirección de email y el identificador del dispositivo en una lista de bloqueo, incluso después de eliminar la cuenta. Esto es estrictamente necesario para evitar la reactivación de una cuenta bloqueada y para proteger a los menores. Esta lista NO contiene tu email en texto claro y no puede usarse para contactarte ni para marketing. La base legal es nuestro interés legítimo en proteger a los menores y la integridad del Servicio (Artículo 6(1)(f) del RGPD). Por separado, y con el mismo fin de prevención de abusos, conservamos un identificador del dispositivo junto con la fecha en que ese dispositivo usó el Servicio por primera vez. Esto es estrictamente necesario para que una asignación introductoria única no pueda reclamarse repetidamente borrando y recreando cuentas en el mismo dispositivo, por lo que se conserva incluso después de eliminar una cuenta. Este registro no contiene dirección de correo electrónico, nombre ni contenido de conversaciones, no se usa para identificarte y nunca se usa con fines de marketing. La base jurídica es el mismo interés legítimo en la integridad del Servicio (Artículo 6(1)(f) del RGPD).
