const PRICING_I18N = {
  en: {
    pricing: {
      ...
      reflection: {
        name: "Reflection", period: "per month", desc: "Daily practice",
  ...
  ro: {
    pricing: {
      ...
      reflection: {
        name: "Reflection", period: "pe lună", desc: "Practică zilnică",
  ...
  es: {
    pricing: {
      ...
      reflection: {
        name: "Reflection", period: "al mes", desc: "Práctica diaria",
...
function applyPricingTranslations(lang) {
  ...
  document.querySelectorAll('[data-pricing-i18n]').forEach((el) => {
    ...
    const value = key.split('.').reduce((obj, k) => (obj == null ? null : obj[k]), data);
...
document.body.addEventListener('click', (e) => {
  ...
  if (btn && btn.dataset.lang) {
    setTimeout(() => applyPricingTranslations(btn.dataset.lang), 30);
  }
});