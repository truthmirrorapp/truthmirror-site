const translations = {
  en: {
    ...
    'screens.subtitle': "Real screens from the app. No mockups.",
  ...
  ro: {
    ...
    'screens.title': "Vezi-o în acțiune",
    'screens.subtitle': "Capturi reale din aplicație. Fără machete.",
    ...
    'footer.contact': 'Contact',
    'footer.deleteAccount': 'Șterge contul',
  ...
  es: {
    ...
    'screens.subtitle': "Capturas reales de la app. Sin maquetas.",
  ...
  ja: {
    ...
    'screens.title': "実際の画面を見る",
    'screens.subtitle': "モックアップではなく、実際のアプリ画面です。",
